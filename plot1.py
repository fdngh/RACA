...
def parse_agrs():
    ...
    parser.add_argument('--load',default='./results/iu_xray/zhishengcheng_model_best.pth', type=str, help='whether to load a pre-trained model.')
